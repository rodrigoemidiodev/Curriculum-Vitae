...
%-----------ABOUT ME------------
\section{About Me}
    \text{My name is Rodrigo Emídio, I am a student currently doing the Master in Computer Science. My main fields of interest are Data Science, and Software and Web Development. In my free time, I enjoy watching TV shows, hanging out with friends, playing video games and doing sports.}
...
\section{University Projects}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \vspace{-13pt}
          \resumeProjectHeading
          {\textbf{Machine Learning Pipeline} $|$ \emph{Python}}{May 2024 -- Jun 2024}
          \resumeItemListStart
            \resumeItem{Developed a machine learning pipeline to predict the length of stay from a patient on ICU, using MIMIC-III database.}
            \resumeItem{Used Google Cloud features to manage and process the data.}
          \resumeItemListEnd
    \resumeSubHeadingListEnd
\vspace{-15pt}
